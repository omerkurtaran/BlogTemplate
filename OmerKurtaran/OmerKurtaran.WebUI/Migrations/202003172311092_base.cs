    ...
    public partial class _base : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Resim", t => t.Resim_Resimıd)
                .Index(t => t.Resim_Resimıd);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Yazar", "Resim_Resimıd", "dbo.Resim");
            ...
            DropIndex("dbo.Yazar", new[] { "Resim_Resimıd" });
